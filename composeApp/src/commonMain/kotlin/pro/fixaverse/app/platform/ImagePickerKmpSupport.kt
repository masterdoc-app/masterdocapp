...
internal fun fixaverseImagePickerConfig(
...
internal fun PhotoResult.toPickedImage(): PickedImage? {
    ...
    val type = mimeType?.takeIf { it.isNotBlank() } ?: guessFixaverseContentType(name)
...
private fun guessFixaverseContentType(fileName: String): String = when {
